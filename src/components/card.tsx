...
const Card: React.FC<CardProps> = ({ imageSrc, title, description, badges }) => {
  return (
    <CardContainer className="border bg-slate-300/25 shadow-2xl shadow-black-600 border-white/[0.2] dark:border-white/[0.2] flex flex-col items-start max-w-sm mx-auto p-4 relative h-[35rem]">
