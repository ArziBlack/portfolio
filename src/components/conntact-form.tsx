                ...
                <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
                    <div className="space-y-12">
                        ...
                        <div>
                            ...
                            <textarea name="message" id="" cols={30} rows={10} className="w-full border border-input-border bg-input px-4 py-1" onChange={handleChange} value={form.message}></textarea>
                        </div>
